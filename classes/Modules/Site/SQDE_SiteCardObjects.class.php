...
class SQDE_SiteCardObjects {
    public static function sequode(){
        ...
        $html[] = 'Sequode Sequencer is a tool for process creation and management in PHP. In the current state, the tool allows you to arrange PHP SPL code elements into processes without having to write the actual code.';
        $html[] = '</div>';
