...
class SQDE_SequodeFormObjects   {
	...
	public static $ajax_library = 'operations/sequode';
    ...
    public static function description($sequode_model = null){
        ...
        $form_object->auto_submit_time = 2000;
        $form_object->submit_ajax_call_parameters = array();
        $form_object->submit_ajax_call_route = static::$ajax_library.'/'.'updateDescription';
        $form_object->submit_ajax_call_parameters[] = SQDE_Sequode::model()->id;
        $form_object->submit_ajax_call_parameters[] = SQDE_Form::$collection_replacement_hook;
		return $form_object;
	}
    ...
    public static function component($type, $map_key, $sequode_model = null){
        ...
        $form_object->submit_ajax_call_route = static::$ajax_library.'/'.'updateValue';
        $form_object->submit_ajax_call_parameters = array();
        $form_object->submit_ajax_call_parameters[] = SQDE_Form::jsQuotedValue($type);
        $form_object->submit_ajax_call_parameters[] = SQDE_Sequode::model()->id;
        $form_object->submit_ajax_call_parameters[] = $map_key;
        $form_object->submit_ajax_call_parameters[] = SQDE_Form::$collection_replacement_hook;
		return $form_object;
	}
	public static function componentSettings($type, $member, $dom_id, $sequode_model = null){
        ...
        $form_object = SQDE_Form::formObject(static::$objects_source,__FUNCTION__,static::$ajax_library,func_get_args());
        $form_object->auto_submit_time = 1;
        $form_object->submit_ajax_call_route = static::$ajax_library.'/'.'updateComponentSettings';
        $form_object->submit_ajax_call_parameters = array();
        $form_object->submit_ajax_call_parameters[] = SQDE_Form::jsQuotedValue($type);
        $form_object->submit_ajax_call_parameters[] = SQDE_Form::jsQuotedValue($member);
        $form_object->submit_ajax_call_parameters[] = SQDE_Form::$collection_replacement_hook;
        $form_object->submit_ajax_call_parameters[] = SQDE_Sequode::model()->id;
        $form_object->submit_ajax_call_parameters[] = SQDE_Form::jsQuotedValue($dom_id);
		return $form_object;
	}
    public static function sequode($dom_id, $sequode_model = null){
        if($sequode_model != null ){ SQDE_Sequode::model($sequode_model); }     
        $form_object = SQDE_Form::formObject(static::$objects_source,__FUNCTION__,static::$ajax_library,func_get_args());
        $form_object->submit_ajax_call_route = static::$ajax_library.'/'.'run';
        $form_object->submit_ajax_call_parameters = array();
        $form_object->submit_ajax_call_parameters[] = SQDE_Sequode::model()->id;
        $form_object->submit_ajax_call_parameters[] = SQDE_Form::$collection_replacement_hook;
    ...
    public static function tenancy($sequode_model = null){
        ...
        $form_object = SQDE_Form::formObject(static::$objects_source,__FUNCTION__,static::$ajax_library,func_get_args());
        $form_object->auto_submit_time = 1;
        $form_object->submit_ajax_call_route = static::$ajax_library.'/'.'updateTenancy';
        $form_object->submit_ajax_call_parameters = array();
        $form_object->submit_ajax_call_parameters[] = SQDE_Sequode::model()->id;
        $form_object->submit_ajax_call_parameters[] = SQDE_Form::$collection_replacement_hook;
		return $form_object;
    ...
    public static function sharing($sequode_model = null){
        ...
        $form_object = SQDE_Form::formObject(static::$objects_source,__FUNCTION__,static::$ajax_library,func_get_args());
        $form_object->auto_submit_time = 1;
        $form_object->submit_ajax_call_route = static::$ajax_library.'/'.'updateSharing';
        $form_object->submit_ajax_call_parameters = array();
        $form_object->submit_ajax_call_parameters[] = SQDE_Sequode::model()->id;
        $form_object->submit_ajax_call_parameters[] = SQDE_Form::$collection_replacement_hook;
		return $form_object;
    ...
    public static function updateIsPalette($sequode_model = null){
        ...
        $form_object = SQDE_Form::formObject(static::$objects_source,__FUNCTION__,static::$ajax_library,func_get_args());
        $form_object->auto_submit_time = 1;
        $form_object->submit_ajax_call_route = static::$ajax_library.'/'.'updateIsPalette';
        $form_object->submit_ajax_call_parameters = array();
        $form_object->submit_ajax_call_parameters[] = SQDE_Sequode::model()->id;
        $form_object->submit_ajax_call_parameters[] = SQDE_Form::$collection_replacement_hook;
		return $form_object;
