<?php
class SQDE_UsersFormObjects   {
    public static $package = 'Users';
	public static $objects_source = 'SQDE_UsersFormComponentObjects';
	public static $ajax_library = 'operations/users';
    public static function updateDomain($user_model = null){
        ...
        $form_object->submit_ajax_call_parameters[] = $user_model->id;
